...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($query->execute()) {
        ...
        echo "<script>alert('Data Berhasil Diedit.');window.location='../datajurusan.php';</script>";
        exit();
    } else {
        // Error in editing data, display error message
        echo "<script>alert('Data Gagal Diedit.');window.location='../datajurusan.php';</script>";
